...
#-----------------------------------------
#Generates a random number between one and
#two and decides, if fortune should run
#with cowsay of figlet.
#This code gets all available cowfiles and
#uses the fortune program to get a test to
#display using cowsay with a different cow
#every time the terminal starts
#-----------------------------------------
#if [ -x /usr/bin/fortune ]; then
#Random_Number=$(shuf -i 1-2 -n 1)
#	if [ $Random_Number -eq 1 ] && [ -x /usr/bin/cowsay ]; then
...
#	elif [ $Random_Number -eq 2 ] && [ -x /usr/bin/figlet ]; then
#		Fige=$( ls /usr/share/figlet/*.flf | shuf -n1 )
#		echo $Fige
#		fortune 50% love 10% medicine 10% linux 10% science 10% computers 10% education | figlet -f $Fige
#	fi
#fi
...
echo -e "\n${BCyan}This is BASH ${BRed}${BASH_VERSION%.*}${BCyan}\
